...
export const Card = ({ children, highlight }: Props) => {
  return (
    <div className="relative" data-component="Card">
      ...
      <div className="border rounded-lg bg-slate-900 bg-opacity-50 border-slate-800 focus-within:bg-opacity-100 focus-within:outline focus-within:outline-cyan-800">
        {children}
      </div>
    </div>
  );
