...
export const Card = ({ children, highlight }: Props) => {
  return (
    <div className="relative" data-component="Card">
      ...
      <div className="overflow-hidden bg-slate-900 bg-opacity-50 rounded-lg text-slate-200 border border-slate-800 focus-within:bg-opacity-100 focus-within:outline focus-within:outline-cyan-800">
        {children}
      </div>
    </div>
  );
